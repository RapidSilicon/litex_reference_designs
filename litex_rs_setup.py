...
git_repos = {
    ...
    "litex_rs":                        GitRepo(url="https://github.com/RapidSilicon/"),
...
#standard_repos.remove("pythondata-misc-usb_ohci")
#standard_repos.remove("pythondata-cpu-vexriscv-smp")
#standard_repos.remove("pythondata-cpu-mor1kx")
#standard_repos.remove("pythondata-cpu-lm32")
#standard_repos.remove("pythondata-cpu-serv")
#standard_repos.remove("pythondata-cpu-naxriscv")
...
def main():
    ...
    parser.add_argument("--config",    default="minimal",  help="Install config (minimal, standard, full).")
